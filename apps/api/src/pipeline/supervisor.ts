...
2. Domain Scores: If the query spans multiple domains (e.g. both programming code AND advanced mathematical derivation), provide scores (0.0 - 1.0) for each relevant domain.
   CRITICAL: Simple greetings ("hi", "hello", "hey"), casual questions, or straightforward single-topic queries MUST be classified as "general" with ONLY ONE domain: [{"domain": "general", "score": 1.0}].
   Do NOT assign multiple domains unless the query genuinely requires multi-team execution.
