...
import { 
  Plus, Folder, FolderTree, User, Sun, Moon, 
...
// Left 1: Home/Plus (+), Left 2: Folders Search, Center/Right 3: File Tree (FolderTree), Right 2: Profile, Right 1: Theme
const MAIN_NAV = [
